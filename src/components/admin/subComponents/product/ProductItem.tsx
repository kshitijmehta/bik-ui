...
import { AppState, SubCategory, getSubCategory, getSize, getColour, Size,
   Colour, Product, addUpdateProduct, setDefaulState, getProduct } from 'reducers';
import { ProductSubCategory, ProductSize, ProductItem as ProductItemType } from 'types';
...
const ProductItem: React.FunctionComponent = () => {
  ...
  const { 
    ...
    sizeId, colourId, imageNames, imagePaths
  ...
  const productItemFormik = useFormik({
    ...
    onSubmit: (values: ProductItemType) => {
      dispatch(addUpdateProduct(values));
    },
...
// console.log(productItemFormik.values)
                  ...
                  <div>
                    <label>
                      ...
                      <select className="uk-select" id="productCategoryId"
                        onChange={(e) => {productItemFormik.handleChange(e); productItemFormik.setFieldValue('subCategory',0);}}
                      ...
                      <select className="uk-select" id="subCategory"
                        ...
                        <option key='0' value={0}>Select</option>
                        {
                          filteredSubcategories.map((subCategory, index) => {
                            return <option key={index} value={subCategory.subCategoryId}>{subCategory.value}</option>
                          })
                        }
                      </select>
                      {
                ...
                <div className="uk-grid-small uk-child-width-1-1 uk-child-width-1-3@s" uk-grid="true">
                  ...
                  <div>
                    <label>
                      ...
                      <input className="uk-input " id="quantity" type="input"
